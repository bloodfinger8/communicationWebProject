<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    	...
    	<script src="https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.11/summernote-bs4.js"></script>
            ...
            <hr/>
            <form name="boardModifyForm" method="post" action="/communicationWebProject/board/boardModify.do">
		      ...
		      <!-- 썸머노트 에디터 사용 -->
		      <textarea id="summernote" name="summernote">${boardDTO.content}</textarea>
		      <button type="button" class="btn btn-primary" onclick="checkBoard2()">글 수정</button>
